    ...
    return (
        <div className='mt-2'>
            <section id='refer' className='flex flex-col'>
                <div className='bg-blue-200 rounded-xl mx-auto md:w-1/2 flex flex-row justify-center items-center h-fit p-4'>
                ...
                <div className='flex flex-col rounded-xl bg-blue-200 mt-10 w-full md:w-2/3 mx-auto p-8 h-fit mb-4'>
                    ...
                    <div className='relative -mt-28'>
                        ...
                        <div className='absolute inset-0 flex justify-around items-center'>
                            <div className='w-40 h-40  rounded-full  flex flex-col justify-center items-center text-center p-4 absolute top-52 left-32'>
                            ...
                            <div className='w-40 h-40  rounded-full  flex flex-col justify-center items-center text-center p-4 absolute top-52 left-18 '>
                            ...
                            <div className='w-40 h-40  rounded-full  flex flex-col justify-center items-center text-center p-4 absolute top-52  right-32'>
